...
1.  **Settings Page:** Configuring API keys for Eventbrite, Square, and general plugin settings. (`includes/admin/screenshots/screenshot1.png`)
2.  **Product Mapping Interface:** Main table for mapping WooCommerce products to Eventbrite Ticket Class IDs and Square Catalog IDs. (`includes/admin/screenshots/screenshot2.png`)
3.  **Date & Time Mapping Modal:** Interface for setting specific Eventbrite/Square mappings for individual dates/times, including the "Suggest" feature. (`includes/admin/screenshots/screenshot3.png`)
4.  **Attendee List Page:** Displaying the combined list of attendees from WooCommerce and Eventbrite for a selected product. (`includes/admin/screenshots/screenshot4.png`)
5.  **Daily Sales Report:** View aggregated sales data from connected platforms. (`includes/admin/screenshots/screenshot5.png`)
6.  **Operation Logs:** Detailed logging for tracking plugin actions and debugging. (`includes/admin/screenshots/screenshot6.png`)
